...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (emojiButton && emojiPicker && messageInput) {
        // Liste d'émojis courants (tu peux en ajouter d'autres)
        const emojis = [
        ...
        emojiPicker.innerHTML = emojis.map(e => `<span class="emoji-item" style="cursor:pointer; padding:2px;">${e}</span>`).join('');
        ...
        // Insertion de l'émoji à la position du curseur
